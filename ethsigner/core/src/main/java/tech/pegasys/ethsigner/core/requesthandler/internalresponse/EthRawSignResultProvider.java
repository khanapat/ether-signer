...
import static tech.pegasys.ethsigner.core.util.EthMessageUtil.getRawEthereumMessage;
...
public class EthRawSignResultProvider implements ResultProvider<String> {

  private static final Logger LOG = LogManager.getLogger();

  private final Eth1AddressSignerProvider transactionSignerProvider;

  public EthRawSignResultProvider(final Eth1AddressSignerProvider transactionSignerProvider) {
  ...
  public String createResponseResult(final JsonRpcRequest request) {
    ...
    final byte[] ethMessage = getRawEthereumMessage(params.get(1)).toArray();
