...
import tech.pegasys.ethsigner.core.requesthandler.internalresponse.EthRawSignResultProvider;
...
public class Runner {
  ...
  private RequestMapper createRequestMapper(
    ...
    requestMapper.addHandler(
        "eth_rawSign",
        new InternalResponseHandler<>(
            responseFactory, new EthRawSignResultProvider(signerProvider)));
    requestMapper.addHandler(
        "eth_signTransaction",
        new InternalResponseHandler<>(
            responseFactory,
